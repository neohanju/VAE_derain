require 'nngraph'
require 'util/Gaussian'

function defineG_VAE(input_nc, output_nc, ngf)
    ...
    local zMean = e8 - nn.SpatialConvolution(ngf * 8, ngf * 8, 1, 1) -- Mean μ of Z
    local zCov  = e8 - nn.SpatialConvolution(ngf * 8, ngf * 8, 1, 1) -- Log variance σ^2 of Z (diagonal covariance)
